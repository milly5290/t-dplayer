  ...
  return function (e) {
    ...
    e.exports = function (e) {
      return new Promise((function (t, p) {
        ...
        if (y.open(e.method.toUpperCase(), r(f, e.params, e.paramsSerializer), !0), y.timeout = e.timeout, y.onreadystatechange = function () {
          ...
          var v = a(54), b = (e.withCredentials || s(f)) && e.xsrfCookieName ? v.read(e.xsrfCookieName) : void 0;
    ...
    var n = a(15), o = /mobile/i.test(window.navigator.userAgent), r = {
      secondToTime: function (e) {
        ...
        var t = Math.floor(e / 3600), a = Math.floor((e - 3600 * t) / 60), n = Math.floor(e - 3600 * t - 60 * a);
        return (t > 0 ? [t, a, n] : [a, n]).map((function (e) {
          return e < 10 ? "0" + e : "" + e
        })).join(":")
      },
      getElementViewLeft: function (e) {
        var t = e.offsetLeft, a = e.offsetParent, n = document.body.scrollLeft + document.documentElement.scrollLeft;
      ...
      send: function (e) {
        ...
        l.a.get(e.url).then((function (t) {
          ...
          a && 0 === a.code ? e.success && e.success(a.data.map((function (e) {
            return { time: e[0], type: e[1], color: e[2], author: e[3], text: e[4], border: e[5] }
    ...
    var c = {
      ...
      k = a.n(x), S = a(22), T = a.n(S), L = a(23), E = a.n(L), q = a(24), B = a.n(q), M = a(25), z = a.n(M), C = a(26),
      A = a.n(C), O = a(27), P = a.n(O), j = a(28), F = a.n(j), _ = a(29), Y = a.n(_), D = a(30), R = a.n(D), I = a(31),
      H = a.n(I), W = a(32), N = a.n(W), U = a(33), V = a.n(U), X = {
        play: h.a,
        pause: f.a,
        volumeUp: b.a,
        volumeDown: w.a,
          ...
          if (this.showing) {
            var a = this.options.height, n = this.container.offsetWidth, o = this.container.offsetHeight,
              i = parseInt(o / a), l = function (e) {
                var a = e.clientWidth || parseInt(e.style.width),
            ...
            for (var p = document.createDocumentFragment(), c = function (o) {
              ...
              switch (e[o].type) {
                case "right":
                  var speed = (l > n && t.options.api.speed) ? (l / t.options.api.speed) : 8;
                  (s = d(i, e[o].type, l)) >= 0 && (i.style.width = l + 1 + "px", i.style.animationDuration = speed + 's', i.style.top = a * s + "px", i.style.transform = "translateX(-".concat(n, "px)"));
                  break;
                case "top":
    ...
    var we = function () {
      function e (t) {
        ...
        !function (e, t) {
          ...
          a.hide()
        }), false), this.player.template.settingButton.addEventListener("click", (function () {
          a.show()
          a.player.template.speed.addEventListener("touchstart", (function (e) {
        ...
        }), false), this.loop = this.player.options.loop, this.player.template.loopToggle.checked = this.loop, this.player.template.loop.addEventListener("click", (function () {
        ...
        for (var n = function (e) {
          ...
          a.player.template.speedItem[e].addEventListener("touchstart", (function () {
            a.player.speed(a.player.template.speedItem[e].dataset.speed), a.hide()
          }))
      ...
      function e (t) {
        ...
        !function (e, t) {
          ...
          api: {
            ...
            speed: this.options.danmaku.speed
          },
          events: this.events,
          tran: function (e) {
            return a.tran(e)
